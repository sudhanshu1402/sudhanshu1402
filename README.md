...
I'm a Backend Engineer at Testlify, based in Mumbai. I started out as a data analyst at Policybazaar, which is where I got hooked on the systems side of things: why a pipeline stalls, where the data goes missing, what happens under load. I moved into backend to work on those problems directly. **Open to backend and platform engineering roles.** Best reached on [LinkedIn](https://www.linkedin.com/in/sudhanshusingh1402/).
...
- Background in data means I care about where numbers come from. I'd rather ship one correct metric than five plausible ones.
...
| **[llm-assessment-pipeline](https://github.com/sudhanshu1402/llm-assessment-pipeline)** | LLM orchestration with dual-model fallback (GPT-4o to Gemini) and Zod-validated structured output. |
